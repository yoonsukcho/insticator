...
(name, url, phone, email, isActive, modifiedat) 
values 
('baseball magazine', 
...
('weekly basketball', 
 ...
 (siteId, content, type, modifiedAt)
 values
...
(questionid, idx, content, isCorrect, modifiedat)
values
...
ADD FOREIGN KEY (siteId) REFERENCES websites(id);
